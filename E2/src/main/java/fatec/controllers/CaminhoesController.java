...
private void CadastroOnAction() {
    ...
    public void AcelerarOnAction() {
        if (Verificar()) {
            ...
            String gifPath = getClass().getResource("/gifs/caminhao-acelerar.gif").toExternalForm();
    ...
    public void FrearOnAction() {
        if (Verificar()) {
            ...
            String gifPath = getClass().getResource("/gifs/caminhao-frear.gif").toExternalForm();
            mbox.ShowGifMessageBox(title, gifPath);
        }
    }
    ...
    public void CarregarOnAction() {
        if (Verificar()) {
            ...
            String gifPath = getClass().getResource("/gifs/caminhao-carregar.gif").toExternalForm();
            mbox.ShowGifMessageBox(title, gifPath);
        }
    }
