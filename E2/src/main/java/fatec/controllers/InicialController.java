...
public class InicialController {
    ...
    private void FelinosOnAction() throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/views/felinos-view.fxml"));
    ...
    private void AquaticosOnAction(javafx.event.ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/views/aquaticos-view.fxml"));
            Parent root = loader.load();
    ...
    private void CarrosOnAction(javafx.event.ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/views/carros-view.fxml"));
            Parent root = loader.load();
    ...
    private void MotosOnAction(javafx.event.ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/views/motos-view.fxml"));
            Parent root = loader.load();
    ...
    private void CaminhoesOnAction(javafx.event.ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/views/caminhoes-view.fxml"));
            Parent root = loader.load();
