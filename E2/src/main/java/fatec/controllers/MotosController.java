...
public class MotosController {
    ...
    public void AcelerarOnAction() {
        if (Verificar()) {
            ...
            String gifPath = getClass().getResource("/gifs/moto-acelerar.gif").toExternalForm();
    ...
    public void FrearOnAction() {
        if (Verificar()) {
            ...
            String gifPath = getClass().getResource("/gifs/moto-frear.gif").toExternalForm();
            mbox.ShowGifMessageBox(title, gifPath);
        }
    }
    ...
    public void EmpinarOnAction() {
        if (Verificar()) {
            ...
            String gifPath = getClass().getResource("/gifs/moto-empinar.gif").toExternalForm();
            mbox.ShowGifMessageBox(title, gifPath);
        }
    }
